...
def run_analisis_qaqc(data_dir, output_dir=None):
    ...
    if "dist_solar_noon_min" in df_solar.columns:
        try:
            ...
            fig.savefig(path_dist, dpi=220, bbox_inches="tight")
            plt.close(fig)
    ...
    if df_estab.empty:
        ...
        try:
            ...
            fig.savefig(path_estab, dpi=220, bbox_inches="tight")
            plt.close(fig)
    ...
    try:
        ...
        fig_funnel.savefig(path_funnel, dpi=220, bbox_inches="tight")
        ...
        fig_w.savefig(path_waterfall, dpi=220, bbox_inches="tight")
        plt.close(fig_w)
        ...
        fig_resumen.savefig(path_resumen, dpi=220, bbox_inches="tight")
