...
| IV600 Isc | 29 | 0.8871 | 0.0049 | ✗ |
| IV600 Pmax | 29 | 0.9318 | 0.0613 | ✓ |
| PV Glasses | 11 | 0.9070 | 0.2245 | ✓ |
| PVStand Isc | 50 | 0.9414 | 0.0153 | ✗ |
| PVStand Pmax | 50 | 0.9525 | 0.0431 | ✗ |
| RefCells | 36 | 0.9020 | 0.0039 | ✗ |
...
- F = 109.4583,  **p < 0.001** → diferencia altamente significativa (ANOVA)

### 3. Kruskal-Wallis (no paramétrico)

- H = 152.5022,  **p < 0.001** → diferencia altamente significativa (Kruskal-Wallis)
...
| DustIQ vs PVStand Pmax | -7.435 pp | 0.0000 |
| IV600 Isc vs PV Glasses | -6.895 pp | 0.0000 |
| IV600 Isc vs PVStand Pmax | -8.391 pp | 0.0000 |
| IV600 Pmax vs PV Glasses | -7.120 pp | 0.0000 |
| IV600 Pmax vs PVStand Pmax | -8.617 pp | 0.0000 |
| PV Glasses vs PVStand Isc | 5.760 pp | 0.0000 |
| PV Glasses vs RefCells | 6.781 pp | 0.0000 |
| PV Glasses vs Soiling Kit | 6.147 pp | 0.0000 |
| PVStand Isc vs PVStand Pmax | -7.257 pp | 0.0000 |
| PVStand Pmax vs RefCells | 8.277 pp | 0.0000 |
| PVStand Pmax vs Soiling Kit | 7.643 pp | 0.0000 |

### 5. Post-hoc Dunn + Bonferroni (pares significativos, p_adj < 0.05)

| Par | p_adj (Bonferroni) |
|---|---|
| DustIQ vs IV600 Pmax | 0.0496 |
| DustIQ vs PV Glasses | 0.0068 |
...
| IV600 Pmax vs PVStand Isc | 0.0437 |
| IV600 Pmax vs PVStand Pmax | 0.0000 |
| PV Glasses vs PVStand Isc | 0.0092 |
