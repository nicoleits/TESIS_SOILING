...
data/ (dentro del directorio del script, p. ej. si_test/data/)
...
# Directorio de salida - ruta relativa al directorio del script
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = SCRIPT_DIR  # Raíz del proyecto = carpeta donde está este script
